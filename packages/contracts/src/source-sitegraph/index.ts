...
export const SitegraphDocMetaSchema = z.object({
    ...
    canonical_title: z.string().min(1).optional(),
    ...
    date_kind: z.string().nullable().optional(),
    date_confidence: z.string().nullable().optional(),
    academic_year: z.string().nullable().optional(),
    term: z.string().nullable().optional(),
    task_kind: z.string().nullable().optional(),
    authority_profile: z.string().nullable().optional(),
